...
const Footer = () => {
  return (
    <div className="px-20 py-32">
      <h2 className="text-5xl font-bold pb-16">Ableton</h2>
      ...
      <div className="flex flex-row justify-between text-xs font-semibold">
        <div className="flex flex-row">
          {FooterData.map((item) => (
            <a className="px-3 py-2 first:pl-0" href={item.link}>{item.title}</a>
          ))}
        </div>
        <div className="flex flex-row">
